...
ARG NEXT_PUBLIC_ALLOW_DEV_MODE
ARG NEXT_PUBLIC_SOLO_B3TR_ADDRESS
ARG NEXT_PUBLIC_SOLO_VOT3_ADDRESS
ARG NEXT_PUBLIC_SOLO_STARGATE_NFT_ADDRESS
ARG NEXT_PUBLIC_SOLO_STARGATE_DELEGATION_ADDRESS
...
ENV NEXT_PUBLIC_VEWORLD_INDEXER_SOLO_URL=${NEXT_PUBLIC_VEWORLD_INDEXER_SOLO_URL}
ENV NEXT_PUBLIC_ALLOW_DEV_MODE=${NEXT_PUBLIC_ALLOW_DEV_MODE}
ENV NEXT_PUBLIC_SOLO_B3TR_ADDRESS=${NEXT_PUBLIC_SOLO_B3TR_ADDRESS}
ENV NEXT_PUBLIC_SOLO_VOT3_ADDRESS=${NEXT_PUBLIC_SOLO_VOT3_ADDRESS}
ENV NEXT_PUBLIC_SOLO_STARGATE_NFT_ADDRESS=${NEXT_PUBLIC_SOLO_STARGATE_NFT_ADDRESS}
ENV NEXT_PUBLIC_SOLO_STARGATE_DELEGATION_ADDRESS=${NEXT_PUBLIC_SOLO_STARGATE_DELEGATION_ADDRESS}
