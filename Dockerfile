...
ARG NEXT_PUBLIC_VEWORLD_INDEXER_SOLO_URL=https://localhost:5000
ARG NEXT_PUBLIC_IS_SOLO
ARG NEXT_PUBLIC_SOLO_NODE_URL
...
ENV NEXT_PUBLIC_IS_SOLO=${NEXT_PUBLIC_IS_SOLO}
ENV NEXT_PUBLIC_SOLO_NODE_URL=${NEXT_PUBLIC_SOLO_NODE_URL}
