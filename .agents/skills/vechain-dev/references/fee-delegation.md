...
```typescript
import { Address, Clause, VET, Transaction, HexUInt, Mnemonic, networkInfo } from '@vechain/sdk-core'
...
const provider = new VeChainProvider(
  thorClient,
  new ProviderInternalBaseWallet([{ privateKey: senderPrivateKey, address: senderAddress }], {
    gasPayer: {
