...
resource "aws_cloudwatch_metric_alarm" "ecs_tasks_below_desired" {
  for_each = local.alerts_enabled ? local.monitored_services : {}
...
resource "aws_cloudwatch_metric_alarm" "alb_no_healthy_targets" {
  count = local.alerts_enabled && local.alb_arn_suffix != null && local.target_group_arn_suffix != null ? 1 : 0
...
resource "aws_cloudwatch_metric_alarm" "alb_elb_5xx" {
  count = local.alerts_enabled && local.alb_arn_suffix != null ? 1 : 0
...
resource "aws_cloudwatch_metric_alarm" "cache_ecpu_high" {
  count = local.alerts_enabled && local.cache_name != null ? 1 : 0
